...
Install the following VSIX from the evergreen CI URL: [NuGetizer 3000 for VS2015](http://bit.ly/nugetizer2015) or [NuGetizer 3000 for VS2017](http://bit.ly/nugetizer2017). Alternatively, you can download the specific build artifact for specifc builds from our [AppVeyor CI](https://ci.appveyor.com/project/MobileEssentials/Merq)
